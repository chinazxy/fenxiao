                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered table-hover">
                                ...
                                <?php if(is_array($orderList)): $i = 0; $__LIST__ = $orderList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$list): $mod = ($i % 2 );++$i;?><tr>
                                        ...
                                        <?php if($list[pay_time] != 0): ?><td class="text-center"><?php echo (date('Y-m-d H:i',$list["pay_time"])); ?></td>
                                        <?php else: ?>
                                            <td class="text-center"><?php echo (date('Y-m-d H:i',$list["add_time"])); ?></td><?php endif; ?>
