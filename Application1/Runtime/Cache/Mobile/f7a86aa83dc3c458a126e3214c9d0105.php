...
<div class="centent_box z-myuser">
  <form id='subm' action="<?php echo U('Mobile/User/edit_address');?>" method="post" >
    ...
    <div style=" height:60px"></div>
    <div class="z-footer">
        <div class="col-xs-12"><input id='save' type="button" value="保存" class="btn btn-block btn-info"/></div><input  type="hidden" name="id" value="<?php echo ($address["address_id"]); ?>" />
    </div>
