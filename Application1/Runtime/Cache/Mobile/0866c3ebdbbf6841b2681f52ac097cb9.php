...
<style>
#pageContent a,#pageContent a:hover,#pageContent a:link,#pageContent a:visited{color:#333;display:block;}
.z-notice .z-div .icon-chevron-right{margin-top:4px;}
</style>
<body>
<div id="pageContent">
	<div class="header2">
...
<div class="goods_nav hid" id="menu">
  ...
  <div class="centent_box z-notice">
    <?php if(is_array($cateList)): foreach($cateList as $key=>$cate): ?><div class="z-div col-xs-12"><a href="<?php echo U('msg_list');?>?id=<?php echo ($cate["id"]); ?>"><?php echo ($cate["type_name"]); if($cate["unred"] > 0): ?><span class="label label-badge label-danger"><?php echo ($cate["unred"]); ?></span><?php endif; ?><i class="icon-chevron-right pull-right"></i></a></div><?php endforeach; endif; ?>
  </div>
</div>
<!-- <div class="footer" >
