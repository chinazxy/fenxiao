...
<body class="body-bg">
    <div class="primary-text">重置密码</div>
    <!-- 输入框 -->
    <form method="POST" id='fo' action="<?php echo U(set_pwd);?>">
	<div class="ccinput-group">
		<input id="pos" name='password' type="password" class="ccinput-input" placeholder="请输入新密码">
    </div>
	<div class="ccinput-group">
		<input id="pos2" name='password2' type="password" class="ccinput-input" placeholder="确认新密码">
    </div>
    <!-- 输入框 -->

    <!-- 下一步 -->
    <a class="cc-btn" href="javascript:void(0);">确认</a>
    </form>
