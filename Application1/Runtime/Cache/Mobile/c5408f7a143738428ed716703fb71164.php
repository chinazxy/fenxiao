...
<div class="goods_nav hid" id="menu">
	...
	<form name="return_form" id="return_form" autocomplete="off" method="post" enctype="multipart/form-data" >
        ...
        <div class="cart">
			<?php if(is_array($goods)): foreach($goods as $key=>$g): ?><div class="product_list1" style="border-bottom:1px solid ;">
					<div class="product_box">
						<div class="product_box_img"><img src="<?php echo ($g["img"]); ?>"></div>
						<div class="name"><?php echo ($g["goods_name"]); ?></div>
						<div class="spec"><i>规格:<?php echo ($g["spec_key_name"]); ?></i><span class="stock">订单数量：<?php echo ($g["goods_num"]); ?></span></div>
		...
		<div class="ques_sq">
			<div class="ques_desc_sq">
				...
				<div class="textarea_sq">
	                <textarea name="reason" id="reason" placeholder="请在此描述详细问题"></textarea>
				</div>
			</div>
		</div>	
