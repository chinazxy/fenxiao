...
<link rel="stylesheet" href="/Template/mobile/new/Static/css/public.css" type="text/css">  
    <div class="mycenter">
    	<div class="my_center_head">
			...
			<?php if($user[is_lock] == 0 and $user[is_temination] == 1): ?><a class="center_bond on" style="color: #fff;">已解约</a>
                <?php elseif($user[is_lock] == 0 and $user[is_temination] == 2 or $user[is_temination] == 3): ?>
                    <a class="center_bond on" style="color: #fff;">解约中</a>
                <?php elseif(($user[is_out] == 1) and ($user[is_lock] == 2)): ?>
                    <a class="center_bond on" style="color: #fff;">等待审核</a>
                <?php elseif($user[is_lock] == 3): ?>
                    <a class="center_bond on" style="color: #fff;">平台审核中</a>
                <?php elseif(($user[is_out] == 2)and ($user[is_lock] == 2)): ?>
                 ...
                 <?php elseif($user[is_lock] == 0): ?>
                    <a class="center_bond on" style="color: #fff;">已缴保证金</a>
            	<?php elseif(($user[is_lock] == 1)): ?>
            		<a class="center_bond on" style="color: #fff;" href="<?php echo U('User/pay_order');?>?type=3">未缴保证金</a><?php endif; ?>
        ...
        <a href="<?php echo U('Mobile/User/my_goods');?>" >
        	<div class="list-block_box">
                ...
                <div class="list-block_box_right"><i class="icon yuer"><img src="/Public/upload/head_pic/20170520/fxs.svg"/></i></div>
            </div>
          </a>
        </div> 
      ...
      <div class="list-block">
    	...
    	<a href="fff.html">
        	<div class="list-block_box">
                ...
                <div class="list-block_box_right"><i class="icon yuer"><img src="/Public/upload/head_pic/20170520/yjf.svg"/></i></div>
            </div>
            </a>
        </div>
        <div class="list-block">
