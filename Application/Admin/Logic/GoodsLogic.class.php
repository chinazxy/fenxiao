...
class GoodsLogic extends RelationModel
{
    ...
    public function getSpecInput($goods_id, $spec_arr)
    {
        ...
        foreach ($spec_arr_sort as $key =>$val)
        {
         ...
         $keySpecGoodsPrice = M('SpecGoodsPrice')->where('goods_id = '.$goods_id)->getField('key,key_name,price,price1,price2,price3,price4,price5,store_count,bar_code');//规格项
       ...
       foreach ($spec_arr2 as $k => $v)
       {
            ...
            $str .="<td>
<input style='width: 100%' name='item[$item_key][price1]' class='spec' value='{$keySpecGoodsPrice[$item_key][price1]}' onkeyup='this.value=this.value.replace(/[^\d.]/g,\"\")' onpaste='this.value=this.value.replace(/[^\d.]/g,\"\")' />
<input type='hidden'  name='price1' class='price' value='{$keySpecGoodsPrice[$item_key][price1]}' onkeyup='this.value=this.value.replace(/[^\d.]/g,\"\")' onpaste='this.value=this.value.replace(/[^\d.]/g,\"\")' /></td>";
            $str .="<td>
<input style='width: 100%' name='item[$item_key][price2]' class='spec' value='{$keySpecGoodsPrice[$item_key][price2]}' onkeyup='this.value=this.value.replace(/[^\d.]/g,\"\")' onpaste='this.value=this.value.replace(/[^\d.]/g,\"\")' />
<input type='hidden' name='price2' class='price' value='{$keySpecGoodsPrice[$item_key][price2]}' onkeyup='this.value=this.value.replace(/[^\d.]/g,\"\")' onpaste='this.value=this.value.replace(/[^\d.]/g,\"\")' />
</td>";
            $str .="<td>
<input style='width: 100%' name='item[$item_key][price3]' class='spec' value='{$keySpecGoodsPrice[$item_key][price3]}' onkeyup='this.value=this.value.replace(/[^\d.]/g,\"\")' onpaste='this.value=this.value.replace(/[^\d.]/g,\"\")' />
<input type='hidden' name='price3'  class='price' value='{$keySpecGoodsPrice[$item_key][price3]}' onkeyup='this.value=this.value.replace(/[^\d.]/g,\"\")' onpaste='this.value=this.value.replace(/[^\d.]/g,\"\")' />
</td>";
            $str .="<td>
<input style='width: 100%' name='item[$item_key][price4]' class='spec' value='{$keySpecGoodsPrice[$item_key][price4]}' onkeyup='this.value=this.value.replace(/[^\d.]/g,\"\")' onpaste='this.value=this.value.replace(/[^\d.]/g,\"\")' />
<input type='hidden' name='price4' class='price' value='{$keySpecGoodsPrice[$item_key][price4]}' onkeyup='this.value=this.value.replace(/[^\d.]/g,\"\")' onpaste='this.value=this.value.replace(/[^\d.]/g,\"\")' />
</td>";
            $str .="<td>
<input style='width: 100%' name='item[$item_key][price5]' class='spec' value='{$keySpecGoodsPrice[$item_key][price5]}' onkeyup='this.value=this.value.replace(/[^\d.]/g,\"\")' onpaste='this.value=this.value.replace(/[^\d.]/g,\"\")' />
<input type='hidden' name='price5' class='price' value='{$keySpecGoodsPrice[$item_key][price5]}' onkeyup='this.value=this.value.replace(/[^\d.]/g,\"\")' onpaste='this.value=this.value.replace(/[^\d.]/g,\"\")' />
</td>";
            $str .="<td>
<input style='width: 100%' name='item[$item_key][price]'  class='spec'  value='{$keySpecGoodsPrice[$item_key][price]}' onkeyup='this.value=this.value.replace(/[^\d.]/g,\"\")' onpaste='this.value=this.value.replace(/[^\d.]/g,\"\")' />
<input type='hidden' name='market_price' class='price' value='{$keySpecGoodsPrice[$item_key][price]}' onkeyup='this.value=this.value.replace(/[^\d.]/g,\"\")' onpaste='this.value=this.value.replace(/[^\d.]/g,\"\")' />
</td>";
            $str .="<td><input style='width: 100%' name='item[$item_key][store_count]' value='{$keySpecGoodsPrice[$item_key][store_count]}' onkeyup='this.value=this.value.replace(/[^\d.]/g,\"\")' onpaste='this.value=this.value.replace(/[^\d.]/g,\"\")'/></td>";
            $str .="<td><input style='width: 100%' name='item[$item_key][bar_code]' value='{$keySpecGoodsPrice[$item_key][bar_code]}' />
        ...
        $str .= "</table>";
        echo "<script>
             var obj =  document.querySelectorAll('.table .spec');
             var c = document.querySelectorAll('.table .price');
