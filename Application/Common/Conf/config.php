...
//     'REQUIRE_AUTH_ACTION'       => '',        // 默认需要认证操作
    ...
    'TAGLIB_BUILD_IN'  =>  'cx,upshop', //  为自定义标签类名称
    ...
    'RETURNING'=> ' AND order_status =6 ', //退货中
    'RETURED'=> ' AND order_status =7 ', //已退货
    'DELETE' =>' AND order_status =5 ',//已
    'REFUSE'=>'AND order_status =8',
    ...
    'APP_SUB_DOMAIN_RULES'    =>    array( 
         'm.bgb.com'   => 'Mobile/',  // 手机访问网站
    ),
        
   //短信验证模板
    "REGISTER_MSG"=>"欢迎注册诚享东方,您的短信验证码为%VERIFY%,不要告诉别人哦",
    "UPDATE_MSG"=>"您的账号%TEL%正在修改密码,短信验证码为%VERIFY%,不要告诉别人哦",
    "DOWN_MSG"=>"您好！诚享东方提醒，有新的下级需要您审核，请及时进系统查看",
    "ORDER_MSG"=>"您好！诚享东方提醒，订单号为%ORDER%需要您发货，请及时进系统查看",
    "FAHUO_MSG"=>"您好！诚享东方提醒，订单号为%ORDER%已发货，请及时进系统查看",
    "RETURN_MSG"=>"您好！诚享东方提醒，订单号为%ORDER%已申请退货，请及时进系统查看",
    "BREAK_MSG"=>"您好！诚享东方提醒，有下级向你提出解约申请，请及时进系统查看",
    "CASHOK_MSG"=>"您好！诚享东方提醒，您的提现请求已成功，请及时进系统查看",
    "CASHNO_MSG"=>"您好！诚享东方提醒，您的提现请求已被拒绝，请及时进系统查看",
    "THROUGH_MSG"=>"您好！欢迎关注厦门诚享东方化妆品有限公司，您的账号申请已审核通过，谢谢！【诚享东方】",
    "WATTING_MSG"=>"您好！欢迎关注厦门诚享东方化妆品有限公司，您的申请资料已提报，请耐心等候审核结果，审核通过后将以短信形式通知！如申请48小时内未收到相关回复，请联系客服电话：4006-225-215。谢谢！【诚享东方】"
