	               ...
	               <nav class="navbar navbar-default">	     
				        <div class="collapse navbar-collapse">
				            <div class="navbar-form row">
					            <a style="display:none" href="<?php echo U('User/level');?>" class="btn btn-primary pull-right"><i class="fa fa-plus"></i>新增等级</a>
				            </div>
				      	</div>
	    			</nav>              
	             </div>	    
		              ...
		              <table id="list-table" class="table table-bordered table-striped dataTable" role="grid" aria-describedby="example1_info">
		                 <thead>
		                   <tr role="row">
			                   ...
			                   <th class="sorting" tabindex="0">首购价格</th>
						...
						<tbody>
						  <?php if(is_array($list)): foreach($list as $k=>$vo): ?><tr role="row" align="center">
		                     ...
		                     <td>
		                      ...
		                      <a style="display:none" class="btn btn-danger" href="javascript:void(0)" data-url="<?php echo U('User/levelHandle');?>" data-id="<?php echo ($vo["level_id"]); ?>" onclick="delfun(this)"><i class="fa fa-trash-o"></i></a>
							</td>
