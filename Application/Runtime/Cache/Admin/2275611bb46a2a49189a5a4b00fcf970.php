      ...
      <div class="login-box-body">
        <p class="login-box-msg">管理后台</p>
          ...
          <div class="form-group">
          	 <button type="button" class="btn btn-primary btn-block btn-flat" onclick="checkLogin()">立即登入 </button>  
          </div>
      </div>
      
	    <div class="margin text-center">
	        <div class="copyright">
	            2016-<?php echo date('Y');?> &copy; <a href="#">商城系统 v1.0.0</a>
	            <br/>
	            <a href="#">诚享东方</a>
	        </div>
	    </div>
