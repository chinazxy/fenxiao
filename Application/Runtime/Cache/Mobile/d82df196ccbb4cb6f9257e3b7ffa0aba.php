...
<div class="goods_nav hid" id="menu">
	...
	<div class="centent_box z-notice_two border_topl">
	  <?php if(is_array($msglist)): foreach($msglist as $key=>$msg): ?><a href="<?php echo U('detail');?>?id=<?php echo ($msg["id"]); ?>"><div class="z-div col-xs-12 mor clearfix"><span class="col-xs-9 text-ellipsis "><?php echo ($msg["title"]); ?></span><span class="pull-right "><?php echo ($msg["c_time"]); ?></span></div></a><?php endforeach; endif; ?>
	</div>
</div>
