...
<div class="z-jxs-detail" style="margin-top:15%">
	<div class="head clearfix">
		...
		<div class="clearfix" style=" text-align:center;width:100%;">
			...
			<div style="display:inline-block; text-align:right;width:auto;"><?php echo ($user["user_name"]); ?></div>
			<div class=" text-primary" style="display:inline-block;text-align:left;width:auto;"><?php echo ($user["level"]); ?></div>
		</div>
	</div>
