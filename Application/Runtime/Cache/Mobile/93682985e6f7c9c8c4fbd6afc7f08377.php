...
<form action="<?php echo U('Mobile/order_list/ajax_order_list');?>" name="filter_form" id="filter_form">
	<!-- <div class="z-order-list-head clearfix"><a class="col-xs-6" style="color:#c50083;font-weight:bold;" href="<?php echo U('/Mobile/User/order_list');?>">我的订单</a><a class="col-xs-6" href="<?php echo U('/Mobile/User/order_list_down');?>">下级订单</a></div> -->
       ...
       <?php if(($list["order_status"] == 2) or ($list["order_status"] == 4)): ?><div class="alert alert-info z-order-list"><?php endif; ?>
			...
			<div class="col-xs-3"><img src="/Public/upload/goods/2016/08-03/57a196524f6c4.jpg"/></div>
            	<div class="col-xs-9 z_kpo">
                	...
                	<div class="lodiv"><a class="btn btn-mini bt_in" href="<?php echo U('Mobile/User/return_goods',array('order_id'=>$list['order_id'],'order_sn'=>$list['order_sn'],'goods_id'=>$list['goods_id']));?>">退货</a></div>
...
var  page = 1;
 ...
 {	 	
		...
		$.ajax({
			type : "POST",
			url:"<?php echo U('Mobile/User/order_ktlist',array('type'=>'ketuihuo'),'');?>/is_ajax/1/p/"+page,//+tab,			
