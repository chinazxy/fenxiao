...
<body class="bg-white1 bg-white">
    ...
    <div class="cart">
      <?php if(is_array($cartList)): foreach($cartList as $key=>$cart): ?><div class="product_list1" >
