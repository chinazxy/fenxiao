...
<body class="bg-white1 bg-white">
	...
	<!-- banner -->
<style>
.z-news{padding-top:50px;padding-bottom:50px;}
</style>
   <div class="z-news ccshop active">
   <?php if(is_array($article)): foreach($article as $key=>$ar): ?><div class="ccshop-item sever sssq">
    	 <a href="<?php echo U('article');?>?article_id=<?php echo ($ar["article_id"]); ?>">
