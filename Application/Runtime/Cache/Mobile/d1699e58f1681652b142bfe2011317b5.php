...
<div class="goods_nav hid" id="menu">
	...
	<div class="z-notice_detail with-padding clearfix">
	<div class="tawr">
    	<h2 class="col-xs-9 text-wzf"><?php echo ($detail["title"]); ?></h3>
        <p class="col-xs-3 text-right text-muted text-wzfs"><?php echo ($detail["c_time"]); ?></p>
		</div>
        <div class="z-notice_detail_content font_lk">
